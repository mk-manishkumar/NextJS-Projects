      ...
      <div className="w-full max-w-md border-2 border-white rounded-2xl p-8 shadow-lg bg-gray-900">
        ...
        <form className="space-y-6" onSubmit={handleRegister}>
          <div>
            ...
            <input type="text" placeholder="Enter Name" className="w-full border-b border-white py-2 px-1 bg-gray-900 text-white outline-none placeholder-gray-400" onChange={(e) => setName(e.target.value)} value={name} />
          </div>
          <div>
