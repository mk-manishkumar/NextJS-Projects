...
const EditProfile = () => {
  ...
  // UI-only toggles (NO functionality)
      ...
      <div className="container max-w-[1200px] mx-auto">
        ...
        <div className="bg-white rounded-[20px] p-6 sm:p-10 shadow-[0_20px_60px_rgba(0,0,0,0.3)] max-w-[800px] mx-auto">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <label className="bg-linear-to-br from-[#667eea] to-[#764ba2] text-white px-6 py-2 rounded-lg font-semibold cursor-not-allowed opacity-60">
              Upload Image
            </label>
          </div>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              className="w-full p-[15px] border-2 border-[#e0e0e0] rounded-[10px] focus:outline-none focus:border-[#667eea]"
            />
          </div>
          ...
          <button
            onClick={handleSave}
            disabled={loading}
            className="w-full py-3 bg-linear-to-br from-[#667eea] to-[#764ba2] text-white rounded-xl font-semibold hover:shadow-lg disabled:opacity-60 cursor-pointer mb-6"
          >
          ...
          <div className="mb-6">
            <button
              ...
              className="w-full p-4 bg-[#f8f9fa] border-2 border-[#e0e0e0] rounded-xl font-semibold flex justify-between items-center"
            >
              <span>Change Password</span>
              <span className={`transition-transform ${showChangePassword ? "rotate-180" : ""}`}>▼</span>
            </button>

            {showChangePassword && (
              <div className="mt-4 p-6 bg-[#f8f9fa] rounded-xl border-2 border-[#e0e0e0] opacity-60">
          ...
          <div>
            <button
              onClick={() => setShowDeleteProfile(!showDeleteProfile)}
              className="w-full p-4 bg-[#fff5f5] border-2 border-[#ff6b6b] text-[#ff6b6b] rounded-xl font-semibold flex justify-between items-center"
            >
