  ...
  return (
    <div className="mt-4 p-6 bg-[#f8f9fa] rounded-xl border-2 border-[#e0e0e0]">
      ...
      <div className="mb-4">
        ...
        <input type="password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} className="w-full p-[14px] border-2 border-[#e0e0e0] rounded-lg focus:outline-none focus:border-[#667eea]" />
      </div>

      {/* New Password */}
      <div className="mb-4">
        <label className="block mb-2 font-semibold text-[#333]">New Password</label>
        <input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full p-[14px] border-2 border-[#e0e0e0] rounded-lg focus:outline-none focus:border-[#667eea]" />
      </div>

      {/* Confirm Password */}
      <div className="mb-6">
        <label className="block mb-2 font-semibold text-[#333]">Confirm New Password</label>
        <input type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="w-full p-[14px] border-2 border-[#e0e0e0] rounded-lg focus:outline-none focus:border-[#667eea]" />
      </div>
